...
run2:
	@./a.out 10000 24 12000 14400000 210000 2 1 200000 7850
	# Do things

run3:
	@./a.out 10000 4 12000 14400000 210000 3 1 20000 7850
	# Do things

run4:
	@mpiexec -np 3 ./a.out 10000 10 12000 14400000 210000 4 1 100000 7850
	# Do things
